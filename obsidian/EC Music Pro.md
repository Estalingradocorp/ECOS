...
- 📜 **Menú lateral:** la lista de canciones es un **drawer izquierdo** desplegable (botón de lista junto a los controles) para **seleccionar canciones** en PC y móvil (88% del ancho en móvil).
